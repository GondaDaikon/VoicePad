...
var toFoumants = (function(){
  ...
  var phon2 = {
    ...
    'ma': [[650, 980 ],[800, 1200]], 'mi': [[210, 1800],[300, 2300]], 'mu': [[150, 980],[300, 1200]], 
    'me': [[350, 1600],[500, 1900]], 'mo': [[350, 600],[500, 800]],
    'pa': [[0, 0],[650, 980 ],[800, 1200]], 'pi': [[0, 0],[210, 1800],[300, 2300]], 'pu': [[0, 0],[150, 920],[300, 1200]], 
    'pe': [[0, 0],[350, 1600],[500, 1900]], 'po': [[0, 0],[350, 600],[500, 800]],
    'ba': [[650, 980 ],[800, 1200]], 'bi': [[210, 1800],[300, 2300]], 'bu': [[150, 920],[300, 1200]], 
...
var Foumants2Disp = (function(){
  return function(vec){
    ...
    vec.forEach(foumant => {
      ...
      tmpX = Math.round((f1/1000) * grid_width*5 + global_gridX);
      tmpY = Math.round((grid_height * 6) - ((f2/3000)*grid_height*6)+global_gridY);
